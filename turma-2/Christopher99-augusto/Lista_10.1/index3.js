...
class Usuario {
  ...
  pagamento(adicionarFormaDePagamento) {
      console.log(`Seu pagamento: ${this.pagamento} foi alterado para: ${this.adicionarFormaDePagamento}`)
  }
}
...
if (opcao === 1) {
  ...
  if (opcao === 2) {
    ...
    if (opcao === 3){
        let adicionarFormaDePagamento = rs.question("Qual a nova forma de pagamento?")
        usuarioDeApp.pagamento(adicionarFormaDePagamento)
    }
  }
}